...
from games.tic_tac_toe_for_train import TicTacToeGameSpec
...
NETWORK_FILE_PATH ='current_network1.p'  # path to save the network to
NUMBER_OF_GAMES_TO_RUN = 10000000
